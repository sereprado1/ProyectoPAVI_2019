...
namespace Proyecto_Molina_Prado_Comba.Capa_de_Acceso_a_Datos
{
    public class ADDescuento
    {
        ...
        //    strSql += " AND descuento=" + "'" + descripcion + "'";
        ...
        //        strSql += " AND (d.porcentaje LIKE '%' + @porcentaje + '%') ";
        ...
        //        Porcentaje = Convert.ToInt32(row["Porcentaje"].ToString())
        //    };
